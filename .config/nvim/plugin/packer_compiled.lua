...
_G.packer_plugins = {
  ...
  ["fugitive-gitlab.vim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/fugitive-gitlab.vim",
  ...
  ["reach.nvim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/reach.nvim",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/rose-pine",
